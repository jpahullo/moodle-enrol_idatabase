...
/**
 * Strings for component 'enrol_idatabase', language 'en'.
 *
 * @package   enrol_idatabase
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['idatabase:unenrol'] = 'Unenrol suspended users';
...
$string['missingcourseaction'] = 'Missing course action';
$string['missingcourseaction_desc'] = 'Local action to do when a local course has no partner on external database.';
$string['missingcoursecategory'] = 'Category for missing courses';
$string['missingcoursecategory_desc'] = 'When local courses has no partner on external database, this category will store all these missing courses.';
$string['missingcourseaction0'] = 'Keep course as is';
$string['missingcourseaction1'] = 'Move course to a given course category';
$string['missingcourseaction2'] = 'Hide course to students';
...
$string['newcoursecategorysynced'] = 'Update course category';
$string['newcoursecategorysynced_desc'] = 'If selected, the course category is updated according to details on external database.';
...
$string['pluginname'] = 'Improved external database';
...
$string['settingsheaderupdatingcourses'] = 'Updating of existing courses';
